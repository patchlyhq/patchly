...
export const LiquidGlassCard = ({
    ...
    draggable || expandable
      ? {
          ...
          dragTransition: draggable
            ? { bounceStiffness: 120, bounceDamping: 20, power: 0.3 }
            : undefined,
  ...
  return (
    <>
      {/* Each instance gets its own filter so multiple cards don't share one ID */}
